...
function csPlayerSelectTarget(cs,data){
  ...
  // 手札選択系
  if(["UNIT_DES_SUM_C2_HAND","UNIT_DES_SUM_C3_HAND","SUM_DES_SUM_C4_HAND","DES_SUMMON_C2_HAND","FUSION_IRON2_HAND","SUM_H_C3X2_STEP1","SUM_H_C3X2_STEP2","SCRAP_BUILD_HAND"].includes(eff)){
